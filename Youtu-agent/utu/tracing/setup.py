...
def setup_otel_tracing(
    ...
    # Check debug flag from environment if not provided
    if debug is None:
        debug = os.getenv("OTEL_LOG_LEVEL", "").upper() == "DEBUG"
    ...
    # Set the tracer provider globally - this is crucial!
    trace.set_tracer_provider(OTEL_TRACING_PROVIDER)
